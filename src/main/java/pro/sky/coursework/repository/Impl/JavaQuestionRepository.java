...
public class JavaQuestionRepository implements QuestionRepository {
    ...
    public JavaQuestionRepository(CheckService checkService) {
    ...
    @PostConstruct
    public void init() {
        Question question_1 = new Question("math 1*1", "1");
        Question question_2 = new Question("math 2*2", "4");
        Question question_3 = new Question("math 3*3", "9");
        Question question_4 = new Question("math 4*4", "16");
        Question question_5 = new Question("math 5*5", "25");
